...
TradeFlow Analytics — это программный комплекс для сбора, хранения и визуализации биржевых данных (или симулированных) в режиме реального времени. 
## Оглавление
...
*   **Redash:** Платформа для построения дашбордов и SQL-аналитики.
...
- **Generator (Python 3.9):** ETL-скрипт. Выполняет запросы к внешнему API, обрабатывает данные и записывает их в базу данных.
- **PostgreSQL (v16/Alpine):** Реляционная база данных. Хранит историю сделок и справочную информацию.
- **Redash (v10):** BI-платформа для построения дашбордов и SQL-аналитики.
- **Redis:** Брокер сообщений и кэш, необходимый для работы очередей Redash.
